import { Msg, IMsgReadonly } from "../helpers/Msg";
...
interface UseMsgState {
  ...
  <T = any>(msg: IMsgReadonly<T> | null | undefined): [T | undefined, (next: T | undefined) => void];
}
...
export const useMsgState = (<T = any>(msg: Msg<T> | null | undefined): [T | undefined, (value: T | undefined) => void] => {
