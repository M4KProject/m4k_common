...
export const flexBox = (options: FlexBoxOptions = {}): FlexCSSProperties => {
  const { direction, align, justify, gap, wrap, grow, shrink, basis, flex, order, alignSelf } =
    options;
...
export const flexCenter = (options: FlexBoxOptions = {}) =>
  flexBox({ align: 'center', justify: 'center', ...options });
export const flexRow = (options: FlexBoxOptions = {}) => flexBox({ direction: 'row', ...options });
export const flexColumn = (options: FlexBoxOptions = {}) =>
  flexBox({ direction: 'column', ...options });
